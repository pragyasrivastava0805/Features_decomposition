...
def main():
  ...
  feature_extractor= ResNet(criterion,output_dim).cuda()
  ...
  for epoch in range(args.epochs):
    ...
    # validation
    valid_acc, valid_obj = infer(source_val_loader,target_val_loader,model,feature_extractor,head_g,criterion,args.batch_size)
...
def train(source_train_loader,source_val_loader,target_train_loader,target_val_loader,criterion,optimizer,optimizer_fe,optimizer_hg,lr,feature_extractor,head_g,model,architect,batch_size):
...
def infer(source_val_loader,target_val_loader,model,feature_extractor,head_g,criterion,batch_size):
  objs = utils.AvgrageMeter()
  top1 = utils.AvgrageMeter()
  top5 = utils.AvgrageMeter()
